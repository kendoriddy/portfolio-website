const projectData = [
  {
    snapshot: "./assets/images/sn2.png",
    projectName: "KSECI",
    technologies: ["React", "JavaScript", "API", "Material UI"],
    live: "https://knowledgest-ai.netlify.app/",
    source: "",
    description:
  ...
  {
    snapshot: "./assets/images/sn4.png",
    projectName: "Kanta",
    technologies: ["Next.JS", "JavaScript", "API", "Tailwind CSS"],
    live: "https://www.getkanta.com/",
    source: "",
    description:
  ...
  },
  {
    ...
    live: "https://pictury.netlify.app/",
    source: "",
    description:
  ...
  },
  {
    ...
    projectName: "Math-Magician & QR Code Generator",
    technologies: ["React", "JavaScript", "CSS", "Linters"],
    live: "https://mathe-magic.netlify.app/",
  ...
  },
  {
    ...
    description: "I created a webapp that tracks the birthdays of my secondary school classmates.",
  },
  {
  ...
  },
  {
    ...
    description:
      "The Space Travelers is a a React, Redux application based on the SpaceX API. This app is built with HTML | CSS | JAVASCRIPT | React and Redux and JEST it uses multiple API to render rockets and missions and enable users to have reserve the reocket and also join the mission.",
  },
  {
    snapshot: "./assets/images/beef.png",
    desktopSnapshot: "./assets/images/math1.png",
    projectName: "BeefLand Eatery",
    technologies: ["Webpack", "JavaScript", "CSS", "HTML"],
    live: "https://kendoriddy.github.io/BeefLand-Eatery/",
  ...
  {
    snapshot: "./assets/images/app-img.png",
    projectName: "Book Store",
    technologies: ["React", "Redux", "Rest API", "Linters"],
    live: "https://a-bookstore.netlify.app/",
